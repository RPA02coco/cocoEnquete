...
export const formInit = {
  ...
  birthday: { label: '【必須】生年月日', value: format(new Date(), "yyyy-MM-dd'T'HH:mm:00'Z'"), pageNum: 0, nextClick: false, valueError: false, errorText: '必須項目です。ご記入をお願いします。' },
  postCode: { label: '【必須】郵便番号', value: '', pageNum: 0, nextClick: false, valueError: true, errorText: '数字で入力してください。例:442-0888' },
  ...
  tel: { label: '【必須】電話番号', value: '', pageNum: 0, nextClick: false, valueError: true, errorText: '数字で入力してください。例:090-1111-2222' },
  mail: { label: '【必須】メールアドレス', value: '', pageNum: 0, nextClick: false, valueError: true, errorText: '英数字で入力してください。例:sample@mail.jp' },
