...
export const formInit = {
  ...
  tel: { label: '【必須】電話番号', value: '', pageNum: 0, nextClick: false, valueError: true, errorText: '数字で入力してください。入力例:090-1111-2222' },
  mail: { label: '【必須】メールアドレス', value: '', pageNum: 0, nextClick: false, valueError: true, errorText: '英数字で入力してください。入力例:sample@mail.jp' },
