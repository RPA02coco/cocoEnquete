...
export const formInit = {
  fullname: { label: '名前', value: '', pageNum: 0, valueError: true, errorText: '必須項目です。ご記入をお願いします。' },
  furigana: { label: 'フリガナ', value: '', pageNum: 0, valueError: true, errorText: '必須項目です。ご記入をお願いします。' },
  dateEntered: { label: '記入日', value: format(new Date(), "yyyy-MM-dd'T'HH:mm:00'Z'") },
  birthday: { label: '誕生日', value: '', pageNum: 0, valueError: true, errorText: '必須項目です。ご記入をお願いします。' },
  postCode: { label: '郵便番号', value: '', pageNum: 0, valueError: true, errorText: '数字で入力してください。入力例:442-0888' },
  address: { label: '住所', value: '', pageNum: 0, valueError: true, errorText: '必須項目です。ご記入をお願いします。' },
  address2: { label: '住所(建物名)', value: '', pageNum: 0 },
  tel: { label: 'TEL', value: '', pageNum: 0, valueError: true, errorText: '数字で入力してください。入力例:090-1111-2222' },
  mail: { label: 'MAIL', value: '', pageNum: 0, valueError: true, errorText: '英数字で入力してください。入力例:sample@mail.jp' },
